...
public class SuperiorCameraLayout extends FrameLayout {
    ...
    public SuperiorCameraLayout(Context context) {
        super(context);
    }

    public SuperiorCameraLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttrs(attrs);
    }

    public SuperiorCameraLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if(null == leftDownView || null == rightUpView){
            return;
        }
